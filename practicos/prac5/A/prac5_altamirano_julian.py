...
def main ():
    ...
    condicion = input('¿Desea ver clientes con deuda mas o menos? Escriba (mas/menos): ')
    cant_clientes_mayores_deuda(personas, limite, condicion)
    limite = float(input('Ingrese un monto para comparar deudas: '))
    condicion = input('¿Desea ver los clientes con deuda mas alta o menos alta? Escriba (mas/menos): ')
    cant_clientes_mayores_deuda(personas, limite, condicion)  
