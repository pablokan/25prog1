from func_lib import input_choice, calcular_edad

# "Vikki Tewkesbury,France,30-01-2000" <- dato
...
def obtener_nombres_edades(datos, inicial):
    ...
    for dato in datos:
        nombre, apellido_y_basura, *_ = dato.split()
        if apellido_y_basura[0] == inicial:
...
def main():
    ...
    print('2)')
    p = input_choice('Germany/United States/Norway/France', 'Elija un país')
    print(obtener_poblacion_pais(personas, p))

    print('3)')
    obtener_nombres_edades(personas, 'b')
