from kan_lib import input_choice, calcular_edad, input_str
...
def obtener_poblacion_por_pais(pais_buscado, datos):
    c = 0
    for dato in datos:
        pais = dato.split(',')[1]
...
print('1)')
print(obtener_poblacion_por_pais('Argentina', personas))

print('2)')
p = input_choice('Germany/United States/Norway/France','Ingrese país a buscar')
print(obtener_poblacion_por_pais(p, personas))

print('3)')
def obtener_nombres_edades(inicial, datos):
...
obtener_nombres_edades(inicial_apellido, personas)
